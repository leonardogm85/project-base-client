...
import { UnidadeMedidaTable } from 'src/app/models/unidade-medida-table';
...
export class ListarComponent implements OnInit, OnDestroy {
  ...
  get tableResult(): TableResult<UnidadeMedidaTable> {
    return this._tableService.result;
  }

  constructor(
    private _unidadeMedidaService: UnidadeMedidaService,
    private _tableService: TableService<UnidadeMedidaTable>,
  ...
  ngOnInit(): void {
    this.subscription.add(this._tableService.onTable(f => this._unidadeMedidaService.obterTabela(f)).subscribe(r => this._tableService.setResult(r)));
  }
  ngOnDestroy(): void {
  ...
  onActivate(id: string): void {
    this.confirm(() => this._unidadeMedidaService.ativar(id), ValidationMessages.confirmarAtivacaoRegistro, ValidationMessages.registroAtivado);
  }
  onDeactivate(id: string): void {
    this.confirm(() => this._unidadeMedidaService.desativar(id), ValidationMessages.confirmarDesativacaoRegistro, ValidationMessages.registroDesativado);
  }
  onDelete(id: string): void {
    this.confirm(() => this._unidadeMedidaService.remover(id), ValidationMessages.confirmarRemocaoRegistro, ValidationMessages.registroRemovido);
  }
