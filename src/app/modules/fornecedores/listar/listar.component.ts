...
import { FornecedorTable } from 'src/app/models/fornecedor-table';
...
export class ListarComponent implements OnInit, OnDestroy {
  ...
  get tableResult(): TableResult<FornecedorTable> {
    return this._tableService.result;
  }

  constructor(
    private _fornecedorService: FornecedorService,
    private _tableService: TableService<FornecedorTable>,
  ...
  ngOnInit(): void {
    this.subscription.add(this._tableService.onTable(f => this._fornecedorService.obterTabela(f)).subscribe(r => this._tableService.setResult(r)));
  }
  ngOnDestroy(): void {
  ...
  onActivate(id: string): void {
    this.confirm(() => this._fornecedorService.ativar(id), ValidationMessages.confirmarAtivacaoRegistro, ValidationMessages.registroAtivado);
  }
  onDeactivate(id: string): void {
    this.confirm(() => this._fornecedorService.desativar(id), ValidationMessages.confirmarDesativacaoRegistro, ValidationMessages.registroDesativado);
  }
  onDelete(id: string): void {
    this.confirm(() => this._fornecedorService.remover(id), ValidationMessages.confirmarRemocaoRegistro, ValidationMessages.registroRemovido);
  }
