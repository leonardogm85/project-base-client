...
export class AtualizarComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = this._usuarioService.obterFormulario();
    this.patchValue();
  }

  patchValue(): void {
    this._usuarioService.obter(this._route.snapshot.paramMap.get('id')).subscribe(m => this.form.patchValue(m));
  }

  onSubmit(): void {
    this._spinnerService.show();
    this._usuarioService.atualizar(this.form.value).pipe(
